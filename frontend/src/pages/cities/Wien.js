...
const Wien = () => {
  ...
  const routes = [
    'Pickup in Wien → Prater/Bermuda-Dreieck → Donauinsel → Club-Tour → Rückkehr',
    'Innenstadt-Tour → Ringstraße → Heurigen in Grinzing → Partymeile',
    'Individuelle Route nach euren Wünschen'
  ];

  return (
    <div className="pt-32 pb-24" data-testid="wien-page">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        ...
        >
          <div className="inline-flex items-center gap-2 glass rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-secondary-main font-unbounded text-sm">Partybus in Wien</span>
          </div>
          <h1 className="font-anton text-5xl md:text-6xl tracking-wider text-white uppercase mb-6">
            Partybus <span className="text-primary-main neon-text">Wien</span> mieten
          </h1>
          <p className="text-text-secondary text-lg font-manrope max-w-3xl mx-auto">
            Ab 650€ für 2 Stunden: JGA, Geburtstag, Firmenfeier, Hochzeit. 
            Premium-Ausstattung mit DJ-Pult, Fotobox & Soundsystem. Sicher feiern in Wien!
          </p>
        </motion.div>
        ...
        >
          {[
            { icon: MapPin, title: 'Wien', desc: 'Alle Bezirke' },
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-6">
            Beliebte <span className="text-secondary-main">Routen in Wien</span>
          </h2>
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-8">
            Events in <span className="text-primary-main">Wien</span>
          </h2>
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-8">
            Verfügbar in <span className="text-secondary-main">Wien</span>
          </h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="font-anton text-3xl md:text-4xl tracking-wider text-white uppercase mb-4">
              Partybus Wien anfragen
            </h2>
            <p className="text-text-secondary font-manrope mb-8 max-w-2xl mx-auto">
              Wir melden uns innerhalb von 24 Stunden mit deinem individuellen Angebot!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/kontakt" className="btn-primary" data-testid="wien-cta">
                Anfrage für Wien
              </Link>

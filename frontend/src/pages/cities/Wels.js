...
const Wels = () => {
  ...
  const routes = [
    'Pickup in Wels → Stadtplatz → Burg Wels → Messegelände → Club-Tour',
    'Wels Altstadt → Kaiser-Josef-Platz → Pollheimerstraße → Partyzone',
    'Individuelle Route durch Oberösterreich ab Wels'
  ];

  return (
    <div className="pt-32 pb-24" data-testid="wels-page">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        ...
        >
          ...
          <h1 className="font-anton text-5xl md:text-6xl tracking-wider text-white uppercase mb-6">
            Partybus <span className="text-primary-main neon-text">Wels</span> mieten
          </h1>
          <p className="text-text-secondary text-lg font-manrope max-w-3xl mx-auto">
            Partybus mieten in Wels ab 650€/2h: Wir organisieren unvergessliche mobile Feiern 
            mit Möglichkeit zum Aussteigen bei den beliebtesten Lokalen der Stadt. 
            Soundsystem, DJ-Pult, LED-Licht, Bar & Fotobox inklusive.
          </p>
        </motion.div>
        ...
        >
          {[
            { icon: MapPin, title: 'Wels', desc: 'Oberösterreich' },
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-6">
            Beliebte <span className="text-secondary-main">Routen in Wels</span>
          </h2>
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-8">
            Events in <span className="text-primary-main">Wels</span>
          </h2>
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-8">
            Verfügbar in <span className="text-secondary-main">Wels</span>
          </h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="font-anton text-3xl md:text-4xl tracking-wider text-white uppercase mb-4">
              Partybus Wels anfragen
            </h2>
            <p className="text-text-secondary font-manrope mb-8 max-w-2xl mx-auto">
              Wir sind direkt vor Ort in Oberösterreich — keine langen Fahrten aus Wien!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/kontakt" className="btn-primary" data-testid="wels-cta">
                Anfrage für Wels
              </Link>

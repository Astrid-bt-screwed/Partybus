...
const Linz = () => {
  ...
  const routes = [
    'Pickup in Linz → Altstadt → Pöstlingberg → Donau-Promenade → Club-Tour',
    'Industrieviertel → Tabakfabrik → Linzer Meile → Partyzone',
    'Individuelle Route durch Oberösterreich'
  ];

  return (
    <div className="pt-32 pb-24" data-testid="linz-page">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        ...
        >
          <div className="inline-flex items-center gap-2 glass rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-secondary-main font-unbounded text-sm">Hauptregion</span>
          </div>
          <h1 className="font-anton text-5xl md:text-6xl tracking-wider text-white uppercase mb-6">
            Partybus <span className="text-primary-main neon-text">Linz</span> mieten
          </h1>
          <p className="text-text-secondary text-lg font-manrope max-w-3xl mx-auto">
            Partybus in Linz ab 650€/2h: Geburtstag, Junggesellenabschied, Firmenfeier. 
            Soundsystem, DJ-Pult, LED-Licht, Bar & Fotobox inklusive. Jetzt unverbindlich anfragen!
          </p>
        </motion.div>
        ...
        >
          {[
            { icon: MapPin, title: 'Linz', desc: 'Unser Hauptsitz' },
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-6">
            Beliebte <span className="text-secondary-main">Routen in Linz</span>
          </h2>
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-8">
            Events in <span className="text-primary-main">Linz</span>
          </h2>
        ...
        >
          <h2 className="font-anton text-3xl tracking-wider text-white uppercase mb-8">
            Verfügbar in <span className="text-secondary-main">Linz</span>
          </h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="font-anton text-3xl md:text-4xl tracking-wider text-white uppercase mb-4">
              Partybus Linz anfragen
            </h2>
            <p className="text-text-secondary font-manrope mb-8 max-w-2xl mx-auto">
              Direkt aus unserer Hauptzentrale in Oberösterreich!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/kontakt" className="btn-primary" data-testid="linz-cta">
                Anfrage für Linz
              </Link>
